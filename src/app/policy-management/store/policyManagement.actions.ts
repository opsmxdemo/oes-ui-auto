...
export const successfullSubmission = createAction('[Policy] SavePolicy', props<{policyData:PolicyManagement,readonly:boolean,editMode:boolean,errorMode:boolean}>());
